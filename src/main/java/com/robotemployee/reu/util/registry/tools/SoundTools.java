...
public class SoundTools {
    ...
    public static Supplier<SoundEvent> registerDiscSound(String name, SoundBuilder.Manager manager) {
    ...
    public static Supplier<SoundEvent> registerNormalSound(String name, String location, SoundBuilder.Manager manager) {
        return manager.createBuilder()
